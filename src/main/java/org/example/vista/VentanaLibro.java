...
public class VentanaLibro extends JFrame{
    ...
    private JPanel panel2; //mostrar libros
    private JPanel panel3; //capturar libros
    private JPanel panel4; //capturar libros
    ...
    public VentanaLibro(String title) throws HeadlessException {
        ...
        panel1.setBackground(new Color(183, 29, 52));
        lblId = new JLabel("ID: ");
        ...
        panel2.setBackground(new Color(62, 45, 172));
        ...
        panel3.setBackground(new Color(25, 105, 16));
        //panel 4
        panel4 = new JPanel(new FlowLayout());
        panel4.setBackground(new Color(167, 124, 30));

        this.getContentPane().add(panel1, 0);
        this.getContentPane().add(panel2, 0);
        this.getContentPane().add(panel3, 0);
        this.getContentPane().add(panel4, 0);
